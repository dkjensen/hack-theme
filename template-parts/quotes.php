<div class="section template-parts-quotes padding-0">
	<div class="template-parts-quotes-slider hack-slick" data-slick='{"dots": true, "arrows": false}'  style="background-image: url(<?php echo esc_url( get_theme_file_uri( 'assets/img/hack-lead-slide-1.jpg' ) ); ?>);">
		<div class="template-parts-quotes-slider--item">
			<div class="wrap">
				<blockquote class="has-quotes">
					<?php
