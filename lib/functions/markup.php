...
function body_classes( $classes ) {
	...
	if ( in_array( $template, array( 'templates/template-about.php', 'templates/template-projects.php', 'templates/template-home.php' ) ) || is_archive() || is_home() || post_password_required() || is_404() ) {
