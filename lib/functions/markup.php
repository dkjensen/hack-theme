...
function body_classes( $classes ) {
	...
	if ( in_array( $template, array( 'templates/template-about.php', 'templates/template-home.php', 'templates/template-impact.php', 'templates/template-faq.php', 'templates/template-challenges.php', 'templates/template-judges.php', 'templates/template-nextstep.php' ) ) || ( is_archive() && ! is_tax( 'location' ) && ! is_tax( 'challenge' ) ) || post_password_required() || is_404() ) {
