		...
		<div class="wrap">
			<div class="row">
				<div class="column six-twelfths">
					<h1><span><?php echo esc_html( '#HACK' ); ?></span><?php esc_html_e( ' 2021 Program', 'hack' ); ?> </h1>
				</div>
			</div>
			<div class="row">
				<div class="column five-twelfths">
				<img class="img-width-80" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/img/events/hack-participant.jpg' ) ); ?>" />
